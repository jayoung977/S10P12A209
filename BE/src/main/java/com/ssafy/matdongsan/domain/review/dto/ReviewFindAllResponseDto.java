...
public class ReviewFindAllResponseDto {
    ...
    public ReviewFindAllResponseDto(Long id, double kindnessRating, double tasteRating, String content, LocalDateTime visitDate, Integer restaurantId, List<AccountSaveReviewRequestDto> accountReviews, List<PersonTagSaveReviewRequestDto> reviewPersonTags) {
        this.id = id;
